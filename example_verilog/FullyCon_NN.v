module TOP(port1);
	...
	/* Island 0 */
	TSMC350nm_4x2_Indirect I__0 (.island_num(0), .row(0), .col(0), .matrix_row(5), .matrix_col(5), .matrix_row(5), .matrix_col(5));
	FNN_DiodeConn I__1 (.island_num(0), .row(0), .col(5), .matrix_row(5), .matrix_col(1), .matrix_row(5), .matrix_col(1));
	FNN_Relu_and_Sig I__2 (.island_num(0), .row(0), .col(6), .matrix_row(5), .matrix_col(1), .matrix_row(5), .matrix_col(1));
