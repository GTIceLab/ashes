...
def compile(project_name, board_type, chip_num):
    ...
    #//exec("{RASPPATH}/prog_assembly/libs/scilab_code/characterization/char_diodeADC.sce",-1);
    ...
    #maybe add the {hid_dir} to the path
        ...
        fd.write(temp)
        fd.close()
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh tunnel_clb {RASPPATH}/prog_assembly/libs/asm_code/tunnel_revtun_CLB_ver00.s43 16384 16384 16384 {path}")
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh switch_program_ble {RASPPATH}/prog_assembly/libs/asm_code/switch_program_ble_ver00.s43 16384 16384 16384 {path}")
    ...
    if n_target_highaboveVt_swc != 0:
        os.system(f"cp {RASPPATH}/prog_assembly/libs/chip_parameters/pulse_width_table/pulse_width_table_swc_chip{chip_num}{brdtype} {path}/pulse_width_table_swc");
        ...
        fd.write(temp)
        fd.close()
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh recover_inject_highaboveVt_SWC {RASPPATH}/prog_assembly/libs/asm_code/recover_inject_highaboveVt_SWC.s43 16384 16384 16384 {path}");
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh first_coarse_program_highaboveVt_SWC {RASPPATH}/prog_assembly/libs/asm_code/first_coarse_program_highaboveVt_SWC.s43 16384 16384 16384 {path}");
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh measured_coarse_program_highaboveVt_SWC {RASPPATH}/prog_assembly/libs/asm_code/measured_coarse_program_highaboveVt_SWC.s43 16384 16384 16384 {path}");
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh fine_program_highaboveVt_m_ave_04_SWC {RASPPATH}/prog_assembly/libs/asm_code/fine_program_highaboveVt_m_ave_04_SWC.s43 16384 16384 16384 {path}");
    ...
    if n_target_aboveVt_swc != 0:
        ...
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh recover_inject_aboveVt_SWC {RASPPATH}/prog_assembly/libs/asm_code/recover_inject_SWC.s43 16384 16384 16384 {path}");
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh first_coarse_program_aboveVt_SWC {RASPPATH}/prog_assembly/libs/asm_code/first_coarse_program_SWC.s43 16384 16384 16384 {path}");
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh measured_coarse_program_aboveVt_SWC {RASPPATH}/prog_assembly/libs/asm_code/measured_coarse_program_aboveVt_SWC.s43 16384 16384 16384 {path}");
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh fine_program_aboveVt_m_ave_04_SWC {RASPPATH}/prog_assembly/libs/asm_code/fine_program_aboveVt_m_ave_04_SWC.s43 16384 16384 16384 {path}");
    ...
    if n_target_subVt_swc != 0:
        ...
        fd.write(temp)
        fd.close()
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh recover_inject_subVt_SWC {RASPPATH}/prog_assembly/libs/asm_code/recover_inject_SWC.s43 16384 16384 16384 {path}");
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh first_coarse_program_subVt_SWC {RASPPATH}/prog_assembly/libs/asm_code/first_coarse_program_SWC.s43 16384 16384 16384 {path}");
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh measured_coarse_program_subVt_SWC {RASPPATH}/prog_assembly/libs/asm_code/measured_coarse_program_subVt_SWC.s43 16384 16384 16384 {path}");
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh fine_program_subVt_m_ave_04_SWC {RASPPATH}/prog_assembly/libs/asm_code/fine_program_subVt_m_ave_04_SWC.s43 16384 16384 16384 {path}");
    ...
    if n_target_lowsubVt_swc != 0:
        os.system(f"cp {RASPPATH}/prog_assembly/libs/chip_parameters/pulse_width_table/pulse_width_table_lowsubVt_swc_chip{chip_num}{brdtype} {path}/pulse_width_table_lowsubVt_swc");
        ...
        fd.write(temp)
        fd.close()
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh recover_inject_lowsubVt_SWC {RASPPATH}/prog_assembly/libs/asm_code/recover_inject_lowsubVt_SWC.s43 16384 16384 16384 {path}");
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh first_coarse_program_lowsubVt_SWC {RASPPATH}/prog_assembly/libs/asm_code/first_coarse_program_lowsubVt_SWC.s43 16384 16384 16384 {path}");
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh measured_coarse_program_lowsubVt_SWC {RASPPATH}/prog_assembly/libs/asm_code/measured_coarse_program_lowsubVt_SWC.s43 16384 16384 16384 {path}");
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh fine_program_lowsubVt_m_ave_04_SWC {RASPPATH}/prog_assembly/libs/asm_code/fine_program_lowsubVt_m_ave_04_SWC.s43 16384 16384 16384 {path}");
    ...
    if n_target_highaboveVt_ota != 0:
        os.system(f"cp {RASPPATH}/prog_assembly/libs/chip_parameters/pulse_width_table/pulse_width_table_ota_chip{chip_num}{brdtype} {path}/pulse_width_table_ota");
        ...
        fd.write(temp)
        fd.close()
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh recover_inject_highaboveVt_CAB_ota {RASPPATH}/prog_assembly/libs/asm_code/recover_inject_highaboveVt_CAB_ota.s43 16384 16384 16384 {path}");
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh first_coarse_program_highaboveVt_CAB_ota {RASPPATH}/prog_assembly/libs/asm_code/first_coarse_program_highaboveVt_CAB_ota.s43 16384 16384 16384 {path}");
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh measured_coarse_program_highaboveVt_CAB_ota {RASPPATH}/prog_assembly/libs/asm_code/measured_coarse_program_highaboveVt_CAB_ota.s43 16384 16384 16384 {path}");
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh fine_program_highaboveVt_m_ave_04_CAB_ota {RASPPATH}/prog_assembly/libs/asm_code/fine_program_highaboveVt_m_ave_04_CAB_ota.s43 16384 16384 16384 {path}");
    ...
    if n_target_aboveVt_ota != 0:
        ...
        fd.write(temp)
        fd.close()
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh recover_inject_aboveVt_CAB_ota {RASPPATH}/prog_assembly/libs/asm_code/recover_inject_CAB_ota.s43 16384 16384 16384 {path}");
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh first_coarse_program_aboveVt_CAB_ota {RASPPATH}/prog_assembly/libs/asm_code/first_coarse_program_CAB_ota.s43 16384 16384 16384 {path}");
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh measured_coarse_program_aboveVt_CAB_ota {RASPPATH}/prog_assembly/libs/asm_code/measured_coarse_program_aboveVt_CAB_ota.s43 16384 16384 16384 {path}");
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh fine_program_aboveVt_m_ave_04_CAB_ota {RASPPATH}/prog_assembly/libs/asm_code/fine_program_aboveVt_m_ave_04_CAB_ota.s43 16384 16384 16384 {path}");
    ...
    if n_target_subVt_ota != 0:
        ...
        fd.write(temp)
        fd.close()
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh recover_inject_subVt_CAB_ota {RASPPATH}/prog_assembly/libs/asm_code/recover_inject_CAB_ota.s43 16384 16384 16384 {path}");
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh first_coarse_program_subVt_CAB_ota {RASPPATH}/prog_assembly/libs/asm_code/first_coarse_program_CAB_ota.s43 16384 16384 16384 {path}");
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh measured_coarse_program_subVt_CAB_ota {RASPPATH}/prog_assembly/libs/asm_code/measured_coarse_program_subVt_CAB_ota.s43 16384 16384 16384 {path}");
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh fine_program_subVt_m_ave_04_CAB_ota {RASPPATH}/prog_assembly/libs/asm_code/fine_program_subVt_m_ave_04_CAB_ota.s43 16384 16384 16384 {path}");
    ...
    if n_target_lowsubVt_ota != 0:
        os.system(f"cp {RASPPATH}/prog_assembly/libs/chip_parameters/pulse_width_table/pulse_width_table_lowsubVt_ota_chip{chip_num}{brdtype} {path}/pulse_width_table_lowsubVt_ota");
        ...
        fd.write(temp)
        fd.close()
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh recover_inject_lowsubVt_CAB_ota {RASPPATH}/prog_assembly/libs/asm_code/recover_inject_lowsubVt_CAB_ota.s43 16384 16384 16384 {path}");
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh first_coarse_program_lowsubVt_CAB_ota {RASPPATH}/prog_assembly/libs/asm_code/first_coarse_program_lowsubVt_CAB_ota.s43 16384 16384 16384 {path}");
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh measured_coarse_program_lowsubVt_CAB_ota {RASPPATH}/prog_assembly/libs/asm_code/measured_coarse_program_lowsubVt_CAB_ota.s43 16384 16384 16384 {path}");
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh fine_program_lowsubVt_m_ave_04_CAB_ota {RASPPATH}/prog_assembly/libs/asm_code/fine_program_lowsubVt_m_ave_04_CAB_ota.s43 16384 16384 16384 {path}");
    ...
    if n_target_aboveVt_otaref != 0:
        os.system(f"cp {RASPPATH}/prog_assembly/libs/chip_parameters/pulse_width_table/pulse_width_table_otaref_chip{chip_num}{brdtype} {path}/pulse_width_table_otaref");
        ...
        fd.write(temp)
        fd.close()
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh recover_inject_aboveVt_CAB_ota_ref {RASPPATH}/prog_assembly/libs/asm_code/recover_inject_CAB_ota_ref.s43 16384 16384 16384 {path}");
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh first_coarse_program_aboveVt_CAB_ota_ref {RASPPATH}/prog_assembly/libs/asm_code/first_coarse_program_CAB_ota_ref.s43 16384 16384 16384 {path}");
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh measured_coarse_program_aboveVt_CAB_ota_ref {RASPPATH}/prog_assembly/libs/asm_code/measured_coarse_program_aboveVt_CAB_ota_ref.s43 16384 16384 16384 {path}");
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh fine_program_aboveVt_m_ave_04_CAB_ota_ref {RASPPATH}/prog_assembly/libs/asm_code/fine_program_aboveVt_m_ave_04_CAB_ota_ref.s43 16384 16384 16384 {path}");
    ...
    if n_target_subVt_otaref != 0:
        ...
        fd.write(temp)
        fd.close()  
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh recover_inject_subVt_CAB_ota_ref {RASPPATH}/prog_assembly/libs/asm_code/recover_inject_CAB_ota_ref.s43 16384 16384 16384 {path}");
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh first_coarse_program_subVt_CAB_ota_ref {RASPPATH}/prog_assembly/libs/asm_code/first_coarse_program_CAB_ota_ref.s43 16384 16384 16384 {path}");
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh measured_coarse_program_subVt_CAB_ota_ref {RASPPATH}/prog_assembly/libs/asm_code/measured_coarse_program_subVt_CAB_ota_ref.s43 16384 16384 16384 {path}");
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh fine_program_subVt_m_ave_04_CAB_ota_ref {RASPPATH}/prog_assembly/libs/asm_code/fine_program_subVt_m_ave_04_CAB_ota_ref.s43 16384 16384 16384 {path}");
    ...
    if n_target_lowsubVt_otaref != 0:
        os.system(f"cp {RASPPATH}/prog_assembly/libs/chip_parameters/pulse_width_table/pulse_width_table_lowsubVt_otaref_chip{chip_num}{brdtype} {path}/pulse_width_table_lowsubVt_otaref");
        ...
        fd.write(temp)
        fd.close()
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh recover_inject_lowsubVt_CAB_ota_ref {RASPPATH}/prog_assembly/libs/asm_code/recover_inject_lowsubVt_CAB_ota_ref.s43 16384 16384 16384 {path}");
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh first_coarse_program_lowsubVt_CAB_ota_ref {RASPPATH}/prog_assembly/libs/asm_code/first_coarse_program_lowsubVt_CAB_ota_ref.s43 16384 16384 16384 {path}");
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh measured_coarse_program_lowsubVt_CAB_ota_ref {RASPPATH}/prog_assembly/libs/asm_code/measured_coarse_program_lowsubVt_CAB_ota_ref.s43 16384 16384 16384 {path}");
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh fine_program_lowsubVt_m_ave_04_CAB_ota_ref {RASPPATH}/prog_assembly/libs/asm_code/fine_program_lowsubVt_m_ave_04_CAB_ota_ref.s43 16384 16384 16384 {path}");
    ...
    if n_target_subVt_mite != 0:
        ...
        fd.write(temp)
        fd.close()
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh recover_inject_subVt_CAB_mite {RASPPATH}/prog_assembly/libs/asm_code/recover_inject_CAB_mite.s43 16384 16384 16384 {path}");
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh first_coarse_program_subVt_CAB_mite {RASPPATH}/prog_assembly/libs/asm_code/first_coarse_program_CAB_mite.s43 16384 16384 16384 {path}");
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh measured_coarse_program_subVt_CAB_mite {RASPPATH}/prog_assembly/libs/asm_code/measured_coarse_program_subVt_CAB_mite.s43 16384 16384 16384 {path}");
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh fine_program_subVt_m_ave_04_CAB_mite {RASPPATH}/prog_assembly/libs/asm_code/fine_program_subVt_m_ave_04_CAB_mite.s43 16384 16384 16384 {path}");
    ...
    if n_target_lowsubVt_mite != 0:
        os.system(f"cp {RASPPATH}/prog_assembly/libs/chip_parameters/pulse_width_table/pulse_width_table_lowsubVt_mite_chip{chip_num}{brdtype} {path}/pulse_width_table_lowsubVt_mite");
        ...
        fd.write(temp)
        fd.close()
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh recover_inject_lowsubVt_CAB_mite {RASPPATH}/prog_assembly/libs/asm_code/recover_inject_lowsubVt_CAB_mite.s43 16384 16384 16384 {path}");
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh first_coarse_program_lowsubVt_CAB_mite {RASPPATH}/prog_assembly/libs/asm_code/first_coarse_program_lowsubVt_CAB_mite.s43 16384 16384 16384 {path}");
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh measured_coarse_program_lowsubVt_CAB_mite {RASPPATH}/prog_assembly/libs/asm_code/measured_coarse_program_lowsubVt_CAB_mite.s43 16384 16384 16384 {path}");
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh fine_program_lowsubVt_m_ave_04_CAB_mite {RASPPATH}/prog_assembly/libs/asm_code/fine_program_lowsubVt_m_ave_04_CAB_mite.s43 16384 16384 16384 {path}");
    ...
    if n_target_aboveVt_dirswc != 0:
        os.system(f"cp {RASPPATH}/prog_assembly/libs/chip_parameters/pulse_width_table/pulse_width_table_dirswc_chip{chip_num}{brdtype} {path}/pulse_width_table_dirswc");
        ...
        fd.write(temp)
        fd.close()
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh recover_inject_aboveVt_DIRSWC {RASPPATH}/prog_assembly/libs/asm_code/recover_inject_DIRSWC.s43 16384 16384 16384 {path}");
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh first_coarse_program_aboveVt_DIRSWC {RASPPATH}/prog_assembly/libs/asm_code/first_coarse_program_DIRSWC.s43 16384 16384 16384 {path}");
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh measured_coarse_program_aboveVt_DIRSWC {RASPPATH}/prog_assembly/libs/asm_code/measured_coarse_program_aboveVt_DIRSWC.s43 16384 16384 16384 {path}");
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh fine_program_aboveVt_m_ave_04_DIRSWC {RASPPATH}/prog_assembly/libs/asm_code/fine_program_aboveVt_m_ave_04_DIRSWC.s43 16384 16384 16384 {path}");
    ...
    if n_target_subVt_dirswc != 0:
        ...
        fd.write(temp)
        fd.close()
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh recover_inject_subVt_DIRSWC {RASPPATH}/prog_assembly/libs/asm_code/recover_inject_DIRSWC.s43 16384 16384 16384 {path}");
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh first_coarse_program_subVt_DIRSWC {RASPPATH}/prog_assembly/libs/asm_code/first_coarse_program_DIRSWC.s43 16384 16384 16384 {path}");
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh measured_coarse_program_subVt_DIRSWC {RASPPATH}/prog_assembly/libs/asm_code/measured_coarse_program_subVt_DIRSWC.s43 16384 16384 16384 {path}");
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh fine_program_subVt_m_ave_04_DIRSWC {RASPPATH}/prog_assembly/libs/asm_code/fine_program_subVt_m_ave_04_DIRSWC.s43 16384 16384 16384 {path}");
    ...
    if n_target_lowsubVt_dirswc != 0:
        os.system(f"cp {RASPPATH}/prog_assembly/libs/chip_parameters/pulse_width_table/pulse_width_table_lowsubVt_dirswc_chip{chip_num}{brdtype} {path}/pulse_width_table_lowsubVt_dirswc");
        ...
        fd.write(temp)
        fd.close()
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh recover_inject_lowsubVt_DIRSWC {RASPPATH}/prog_assembly/libs/asm_code/recover_inject_lowsubVt_DIRSWC.s43 16384 16384 16384 {path}");
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh first_coarse_program_lowsubVt_DIRSWC {RASPPATH}/prog_assembly/libs/asm_code/first_coarse_program_lowsubVt_DIRSWC.s43 16384 16384 16384 {path}");
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh measured_coarse_program_lowsubVt_DIRSWC {RASPPATH}/prog_assembly/libs/asm_code/measured_coarse_program_lowsubVt_DIRSWC.s43 16384 16384 16384 {path}");
        os.system(f"{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh fine_program_lowsubVt_m_ave_04_DIRSWC {RASPPATH}/prog_assembly/libs/asm_code/fine_program_lowsubVt_m_ave_04_DIRSWC.s43 16384 16384 16384 {path}");
    ...
    if (Signal_DAC_check==1) and (GPIO_IN_check==0) and (RAMP_ADC_check==1):
        if sftreg_check==1: 
            ...
            print("shift here");
        #else os.system("{RASPPATH}/prog_assembly/libs/sh/asm2ihex2.sh voltage_meas {RASPPATH}/prog_assembly/libs/asm_code/Ramp_ADC_DAC.s43 16384 16384 16384 {path}"); print
        #print("RAMP here");
        else:
