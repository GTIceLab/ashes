...
def main(bs_circuit_loc, bs_run_dir, bs_board_arch, bs_vpr_disp=None, bs_pins_file=None):
    ...
    ## Call first pass VTR
    print(f'{RASPPATH}/vtr_release/vpr/vpr {ASHESPATH}/ashes_fg/fpaa/arch/'+bs_board_arch+'_arch.xml ' + bs_circuit_loc  +'  -route_chan_width 17 -timing_analysis off -fix_pins ' + bs_circuit_loc + '.pads -nodisp')
    os.system(f'{RASPPATH}/vtr_release/vpr/vpr {ASHESPATH}/ashes_fg/fpaa/arch/'+bs_board_arch+'_arch.xml ' + bs_circuit_loc + '  -route_chan_width 17 -timing_analysis off -fix_pins ' + bs_circuit_loc + '.pads -nodisp')
