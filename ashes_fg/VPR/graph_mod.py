...
# Step 3: Add new one-to-one bidirectional edges (CHANX 0-19 to CHANY 20-39 ABOVE)
print("Pass 1: Adding new edges (CHANX 0-19 to CHANY 20-39 ABOVE)...")
edges_added_count_above = 0

if rr_edges is not None:
    for x in range(0, 9):          
        for y in range(0, 9):      
            for ptc_x in range(0, 20):  
...
# Step 4: Add new one-to-one bidirectional edges (CHANX 0-19 to CHANY 20-39 SAME LEVEL)
print("Pass 2: Adding new edges (CHANX 0-19 to CHANY 20-39 SAME LEVEL)...")
edges_added_count_same_level_20_39 = 0
        ...
        for y in range(0, 9):      
            for ptc_x in range(0, 20):  
                ...
                if src_key in chanx_dict and sink_key in chany_dict:
                    ...
                    rr_edges.append(new_edge_forward)
                    rr_edges.append(new_edge_backward)
                    edges_added_count_same_level_20_39 += 2

print(f"  -> Pass 2 complete: {edges_added_count_same_level_20_39} edges added.")

# Step 5: Add new one-to-one bidirectional edges (CHANX 0-19 to CHANY 0-19 SAME LEVEL)
print("Pass 3: Adding new edges (CHANX 0-19 to CHANY 0-19 SAME LEVEL)...")
edges_added_count_same_level_0_19 = 0
        ...
        for y in range(0, 9):      
            for ptc_x in range(0, 20):  
                ...
                if src_key in chanx_dict and sink_key in chany_dict:
                    ...
                    rr_edges.append(new_edge_forward)
                    rr_edges.append(new_edge_backward)
                    edges_added_count_same_level_0_19 += 2

print(f"  -> Pass 3 complete: {edges_added_count_same_level_0_19} edges added.")

# Step 6: Add new one-to-one bidirectional edges (CHANY 0-19 to CHANY 20-39 ABOVE)
print("Pass 4: Adding new edges (CHANY 0-19 to CHANY 20-39 ABOVE)...")
edges_added_count_chany_above = 0

if rr_edges is not None:
    for x in range(0, 9):          
        for y in range(0, 9):      
            for ptc_y1 in range(0, 20):  
...
# Step 7: Add new one-to-one bidirectional edges (CHANY 0-19 to CHANY 20-39 SAME LEVEL)
print("Pass 5: Adding new edges (CHANY 0-19 to CHANY 20-39 SAME LEVEL)...")
...
# Step 8: Add new one-to-one bidirectional edges (CHANY 0-19 to CHANX 0-19 RIGHT)
print("Pass 6: Adding new edges (CHANY 0-19 to CHANX 0-19 RIGHT)...")
edges_added_count_chany_chanx_right = 0

if rr_edges is not None:
    for x in range(0, 9):          
        for y in range(0, 9):      
            for ptc in range(0, 20):  
...
# Step 9: Add new one-to-one bidirectional edges (CHANY 20-39 to CHANY 20-39 ABOVE)
print("Pass 7: Adding new edges (CHANY 20-39 to CHANY 20-39 ABOVE)...")
edges_added_count_chany_above_20_39 = 0

if rr_edges is not None:
    for x in range(0, 9):          
        for y in range(0, 9):      
            for ptc in range(20, 40):  
                ...
                if src_key in chany_dict and sink_key in chany_dict:
                    ...
                    rr_edges.append(new_edge_forward)
                    rr_edges.append(new_edge_backward)
                    edges_added_count_chany_above_20_39 += 2

print(f"  -> Pass 7 complete: {edges_added_count_chany_above_20_39} edges added.")

# Step 10: Write the modified tree to the output file
total_new_edges = (edges_added_count_above + 
                   edges_added_count_same_level_20_39 + 
                   edges_added_count_same_level_0_19 +
                   edges_added_count_chany_above +
                   edges_added_count_chany_same_level +
                   edges_added_count_chany_chanx_right +
                   edges_added_count_chany_above_20_39)
