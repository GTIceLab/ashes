...
for i in range(7):
	...
	Fabric.n_gatebit2[i] += LVLShifter1.OUT[12]
	Fabric.n_gatebit3[i] += LVLShifter1.OUT[13]
	Fabric.n_gatebit4[i] += LVLShifter1.OUT[14]
	Fabric.n_gatebit5[i] += LVLShifter1.OUT[15]
...
#west unbuffered IO
Fabric.w_s0[4] += chipframe.IO_W[31]
Fabric.w_s1[4] += chipframe.IO_W[32]
Fabric.w_s2[4] += chipframe.IO_W[33]
Fabric.w_s10[4] += chipframe.IO_W[34]
Fabric.w_s17[4] += chipframe.IO_W[35]
Fabric.w_s19[4] += chipframe.IO_W[36]
Fabric.w_s0[5] += chipframe.IO_W[37]
Fabric.w_s1[5] += chipframe.IO_W[38]
Fabric.w_s4[5] += chipframe.IO_W[39]
Fabric.w_s11[5] += chipframe.IO_W[40]
Fabric.w_s18[5] += chipframe.IO_W[41]
Fabric.w_s19[5] += chipframe.IO_W[42]


#east unbuffered IO
Fabric.e_s0[4] += chipframe.IO_E[31]
Fabric.e_s1[4] += chipframe.IO_E[32]
Fabric.e_s2[4] += chipframe.IO_E[33]
Fabric.e_s10[4] += chipframe.IO_E[34]
Fabric.e_s17[4] += chipframe.IO_E[35]
Fabric.e_s19[4] += chipframe.IO_E[36]
Fabric.e_s0[5] += chipframe.IO_E[37]
Fabric.e_s1[5] += chipframe.IO_E[38]
Fabric.e_s4[5] += chipframe.IO_E[39]
Fabric.e_s11[5] += chipframe.IO_E[40]
Fabric.e_s18[5] += chipframe.IO_E[41]
Fabric.e_s19[5] += chipframe.IO_E[42]

#north unbuffered IO
Fabric.e_s11[0] += chipframe.IO_N[35]
Fabric.e_s10[0] += chipframe.IO_N[34]
Fabric.e_s9[0] += chipframe.IO_N[33]
Fabric.e_s8[0] += chipframe.IO_N[32]
Fabric.e_s7[0] += chipframe.IO_N[31]
Fabric.e_s6[0] += chipframe.IO_N[30]
Fabric.e_s5[0] += chipframe.IO_N[29]
Fabric.e_s4[0] += chipframe.IO_N[28]
Fabric.e_s3[0] += chipframe.IO_N[27]
Fabric.e_s2[0] += chipframe.IO_N[26]
Fabric.e_s1[0] += chipframe.IO_N[25]
Fabric.e_s0[0] += chipframe.IO_N[24]
...
compile_asic(Top,process="TSMC350nm",fileName="FPAA_general",p_and_r = True,design_limits = design_limits, location_islands = location_islands,drainSpaceIdx=7,drainSpace =50,gateSpaceIdx=7,gateSpace=15)
