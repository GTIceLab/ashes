...
Fabric1 = sensor_cab1(Top,FabricIsland,[7,1])
Fabric1.place([0,0])

Fabric2 = sensor_cab2(Top,FabricIsland,[7,6])
Fabric2.place([0,1])
...
compile_asic(Top,process="TSMC350nm",fileName="FPAA_Sensor",p_and_r = True,design_limits = design_limits, location_islands = location_islands,drainSpaceIdx=7,drainSpace =20,gateSpaceIdx=7,gateSpace=15)
