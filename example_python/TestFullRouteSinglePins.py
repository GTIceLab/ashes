...
compile_asic(Top,process="TSMC350nm",fileName="test_prerana2",p_and_r = True,design_limits = design_limits, location_islands = location_islands,drainSpaceIdx=7,drainSpace =20,gateSpaceIdx=7,gateSpace=15)