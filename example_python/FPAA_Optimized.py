...
# Compilation
#-------------------------------------------------------------------------------
design_limits = [13e6, 13e6]
location_islands = ((250600, 4530000), #macro
(20600, 20000), #frame
(300000,210000), #Fabric
(1600000,4520000), #LVLShifter1
(2200000,4520000), #LVLShifter2
(3400000,4520000), #LVLShifter3
(2800000,4520000), #DigBuffer
(6400000,4000000)) #Analog BUffer
