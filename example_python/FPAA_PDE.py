...
Fabric = PDE_cab1(Top,FabricIsland,[9,9])
Fabric.place([0,0])
...
GateSwitch_buf.decode[0] += LVLShifter3.OUT[10]
...
DrainDecoder_buf.ENABLE += LVLShifter3.OUT[11]
DrainDecoder_buf.IN += LVLShifter3.OUT[12:16]
...
Fabric.n_gateEN[0] += LVLShifter3.OUT[0]
Fabric.n_gateEN[1] += LVLShifter3.OUT[1]
Fabric.n_gateEN[2] += LVLShifter3.OUT[2]
Fabric.n_gateEN[3] += LVLShifter3.OUT[3]
Fabric.n_gateEN[4] += LVLShifter3.OUT[4]
Fabric.n_gateEN[5] += LVLShifter3.OUT[5]
Fabric.n_gateEN[6] += LVLShifter3.OUT[6]
Fabric.n_gateEN[7] += LVLShifter3.OUT[7]
Fabric.n_gateEN[8] += LVLShifter3.OUT[8]

for i in range(9):
	Fabric.n_gatebit0[i] += LVLShifter2.OUT[9]
	Fabric.n_gatebit1[i] += LVLShifter2.OUT[10]
	Fabric.n_gatebit2[i] += LVLShifter2.OUT[11]
	Fabric.n_gatebit3[i] += LVLShifter2.OUT[12]
	Fabric.n_gatebit4[i] += LVLShifter2.OUT[13]
...
macro.Signal_RampADC_inp[5] += Fabric.n_s7[6]
macro.Signal_RampADC_inp[4] += Fabric.n_s6[6]
macro.Signal_RampADC_inp[3] += Fabric.n_s5[6]
macro.Signal_RampADC_inp[2] += Fabric.n_s4[6]
macro.Signal_RampADC_inp[1] += Fabric.n_s3[6]
macro.Signal_RampADC_inp[0] += Fabric.n_s2[6]
macro.Signal_DAC_out[2] += Fabric.n_s2[7]
macro.Signal_DAC_out[1] += Fabric.n_s1[7]
macro.Signal_DAC_out[0] += Fabric.n_s0[7]

#west and east buffered IO
Fabric.e_s0[0] += AnalogBuffer1[0].Vin
Fabric.e_s1[0] += AnalogBuffer1[1].Vin
Fabric.e_s2[0] += AnalogBuffer1[2].Vin
Fabric.e_s3[0] += AnalogBuffer1[3].Vin
Fabric.e_s4[0] += AnalogBuffer1[4].Vin
Fabric.e_s5[0] += AnalogBuffer1[5].Vin
Fabric.e_s6[0] += AnalogBuffer1[6].Vin
Fabric.e_s7[0] += AnalogBuffer1[7].Vin
Fabric.e_s0[1] += AnalogBuffer1[8].Vin
Fabric.e_s1[1] += AnalogBuffer1[9].Vin
Fabric.e_s2[1] += AnalogBuffer1[10].Vin
Fabric.e_s3[1] += AnalogBuffer1[11].Vin
Fabric.e_s4[1] += AnalogBuffer1[12].Vin
Fabric.e_s5[1] += AnalogBuffer1[13].Vin
Fabric.e_s6[1] += AnalogBuffer1[14].Vin
Fabric.e_s7[1] += AnalogBuffer1[15].Vin
...
#west unbuffered IO
Fabric.w_s0[6] += chipframe.IO_W[31]
Fabric.w_s6[6] += chipframe.IO_W[32]
Fabric.w_s7[6] += chipframe.IO_W[33]
Fabric.w_s0[7] += chipframe.IO_W[34]
Fabric.w_s1[7] += chipframe.IO_W[35]
Fabric.w_s2[7] += chipframe.IO_W[36]
Fabric.w_s7[7] += chipframe.IO_W[37]
Fabric.w_s0[8] += chipframe.IO_W[38]
Fabric.w_s1[8] += chipframe.IO_W[39]
Fabric.w_s2[8] += chipframe.IO_W[40]
Fabric.w_s6[8] += chipframe.IO_W[41]
Fabric.w_s7[8] += chipframe.IO_W[42]


#east unbuffered IO
Fabric.e_s0[6] += chipframe.IO_E[31]
Fabric.e_s6[6] += chipframe.IO_E[32]
Fabric.e_s7[6] += chipframe.IO_E[33]
Fabric.e_s0[7] += chipframe.IO_E[34]
Fabric.e_s1[7] += chipframe.IO_E[35]
Fabric.e_s2[7] += chipframe.IO_E[36]
Fabric.e_s7[7] += chipframe.IO_E[37]
Fabric.e_s0[8] += chipframe.IO_E[38]
Fabric.e_s1[8] += chipframe.IO_E[39]
Fabric.e_s2[8] += chipframe.IO_E[40]
Fabric.e_s6[8] += chipframe.IO_E[41]
Fabric.e_s7[8] += chipframe.IO_E[42]
...
Fabric.s_s2[7] += chipframe.IO_S[37]
Fabric.s_s1[7] += chipframe.IO_S[36]
Fabric.s_s0[7] += chipframe.IO_S[35]
Fabric.s_s7[6] += chipframe.IO_S[34]
Fabric.s_s6[6] += chipframe.IO_S[33]
Fabric.s_s5[6] += chipframe.IO_S[32]
...
(20600, 20000), #frame
(250000,210000), #Fabric
(400000,4500000), #LVLShifter1
(3300000,4500000), #LVLShifter2
(4100000,4500000), #LVLShifter3
(1500000,4500000), #DigBuffer
(6470000,3950000)) #Analog BUffer
